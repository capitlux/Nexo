...
chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
    ...
    switch (message.id) {
        ...
        case CONST_QuantityRequestFromServer:
            ...
            break;
        case CONST_ProductOrderRequestFromServer:
            //prepare request
            var request = {
                id: CONST_ProductOrderRequest,
                originType: CONST_ProductOrderRequestFromServer,
                serverUrlBase: message.serverUrlBase,
                requestId: message.requestId,
                catalogId: message.catalogId,
                items: message.items,
        ...
        case CONST_QuantityResponse:
            ...
            break;
        case CONST_ProductOrderResponse:
            console.dir(message);
            if (message.request.originType == CONST_ProductOrderRequestFromServer) {
                //Post results
                $.ajax({
                    type: "POST",
                    contentType: "application/json",
                    url: message.request.serverUrlBase + "/CatalogService/PostProductOrderResponse",
                    dataType: 'json',
                    data: JSON.stringify(message.request),
                    success: function (ajaxResult) {
                    }
